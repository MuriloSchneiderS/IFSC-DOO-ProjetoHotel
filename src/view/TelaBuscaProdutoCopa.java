...
public class TelaBuscaProdutoCopa extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Descricao", "Valor", "Obs", "CopaQuarto"
            }
        ));
        ...
        if (jTableDados.getColumnModel().getColumnCount() > 0) {
            ...
            jTableDados.getColumnModel().getColumn(1).setMaxWidth(175);
            jTableDados.getColumnModel().getColumn(2).setMaxWidth(100);
            jTableDados.getColumnModel().getColumn(3).setMaxWidth(120);
            jTableDados.getColumnModel().getColumn(4).setMaxWidth(85);
        }
        ...
        jCBFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Descricao", "Valor", "Obs", "CopaQuarto" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaProdutoCopa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
