...
public class TelaBuscaVeiculo extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        if (jTableDados.getColumnModel().getColumnCount() > 0) {
            ...
            jTableDados.getColumnModel().getColumn(1).setMaxWidth(100);
            jTableDados.getColumnModel().getColumn(2).setMaxWidth(70);
            jTableDados.getColumnModel().getColumn(3).setMaxWidth(150);
        ...
        jCBFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Placa", "Cor", "Marca", "Modelo" }));
